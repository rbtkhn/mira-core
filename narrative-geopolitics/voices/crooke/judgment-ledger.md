...
# Alastair Crooke Judgment Ledger
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `VJ-CROOKE-0001` | `mechanism` | `active` | Escalation narrows diplomatic room and can turn a coercive campaign into a wider regional war. | `2026-07-20` | `2026-07-20` | `close-paraphrase` | [source-alastair-crooke-iran-war-3-0-2026-07-20.md](../../archive/sources/2026-07-20/source-alastair-crooke-iran-war-3-0-2026-07-20.md) |

## Version History

| Version | Judgment | First Seen | Last Seen | Review Condition | Legacy IDs |
| --- | --- | --- | --- | --- | --- |
| `VJ-CROOKE-0001-v1` | `VJ-CROOKE-0001` | `2026-07-20` | `2026-07-20` | Legacy trajectory requires source-level normalization before accountability use. | `STATE-CROOKE-0001` |
...
| --- | --- | --- |
| `VJ-CROOKE-0001` | `NG-20260720-F01` | none |
