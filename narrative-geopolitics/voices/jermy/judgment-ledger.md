...
| --- | --- | --- | --- | --- | --- | --- | --- |
| none | none | none | No canonical judgment object has been migrated for this voice. | none | none | none | none |
...
| Item | Reason |
| --- | --- |
| `VR-20260301-02` | Canonical revision is not yet mapped to a canonical judgment object. |
| `VR-20260318-01` | Canonical revision is not yet mapped to a canonical judgment object. |
