...
| --- | --- | --- | --- | --- |
| `2026-01-13` | Regime change escalator w/ Robert Barnes (Live) | `host-pressure test` | `the-duran` | [source](../../archive/sources/2026-01-13/source-duran-mercouris-barnes-regime-change-escalator-2026-01-13.md) |
...
| `2026-05-26` | Robert Barnes: US-Iran FINAL Confrontation as Russia Drops HEAVIEST Strikes on Ukraine Yet | `host-pressure test` | `dialogue-works` | [source](../../archive/sources/2026-05-26/source-dialogue-works-barnes-us-iran-final-confrontation-as-russia-drops-heaviest-strikes-on-ukraine-yet-2026-05-26.md) |
...
| `2026-05-30` | IRAN WAR - NO DECISION MADE /Lt Col Daniel Davis & Robert Barnes | `host-pressure test` | `daniel-davis` | [source](../../archive/sources/2026-05-30/source-daniel-davis-iran-war-no-decision-made-lt-col-daniel-davis-robert-barnes-2026-05-30.md) |
| `2026-05-31` | BREAKING: U.S. TO MERGE MILITARY WITH ISRAEL - w/ Political Analyst Robert Barnes | `host-pressure test` | `mario-nawfal` | [source](../../archive/sources/2026-05-31/source-mario-nawfal-barnes-breaking-u-s-to-merge-military-with-israel-2026-05-31.md) |
...
| `2026-06-03` | Robert Barnes: The Iranian Navy announces it targeted a U.S. warship in the Sea of Oman | `host-pressure test` | `dialogue-works` | [source](../../archive/sources/2026-06-03/source-dialogue-works-barnes-the-iranian-navy-announces-it-targeted-a-us-warship-in-the-sea-of-oman-2026-06-03.md) |
| `2026-06-08` | BREAKING: IRAN LAUNCHES ATTACK ON U.S. BASES – w/ Political Analyst Robert Barnes | `host-pressure test` | `mario-nawfal` | [source](../../archive/sources/2026-06-08/source-mario-nawfal-barnes-breaking-iran-launches-attack-on-u-s-bases-2026-06-08.md) |
| `2026-06-10` | Robert Barnes: US Attacks Iran: Jordan, Bahrain & Kuwait Were Hit Within Hours | `host-pressure test` | `dialogue-works` | [source](../../archive/sources/2026-06-10/source-dialogue-works-barnes-us-attacks-iran-jordan-bahrain-kuwait-hit-within-hours-2026-06-10.md) |
| `2026-06-10` | Robert Barnes : How Trump Makes Decisions | `host-pressure test` | `judging-freedom` | [source](../../archive/sources/2026-06-10/source-judging-freedom-barnes-how-trump-makes-decisions-2026-06-10.md) |
...
| `2026-06-25` | BREAKING: GCC ATTACK IRAN AFTER MARCO RUBIO MEETING, IRAN STRIKE VESSEL IN HORMUZ w/ Robert Barnes | `host-pressure test` | `mario-nawfal` | [source](../../archive/sources/2026-06-25/source-mario-nawfal-barnes-breaking-gcc-attack-iran-rubio-meeting-iran-strike-vessel-hormuz-2026-06-25.md) |
