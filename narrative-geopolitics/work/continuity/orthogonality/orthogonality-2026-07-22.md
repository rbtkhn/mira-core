...
| `macgregor` | unmapped | Daily source set centers on Colonel Douglas MacGregor: Breaking - Trump Threatens Bridges & Power Plants Destruction in Tehran Bloomberg: Gulf Allies Push Trump to Invade Iran & Seize Kharg Island - w/ Col. Macgregor. | Temporary daily identity requires human review. | SRC-02,SRC-04 | mario-nawfal, moral-resistance | human review required |
| `mercouris` | room / sequence / legitimacy | Daily source set centers on Russia Strikes Odessa 24/7 Reaches Kramatorsk; Zelensky Panics Sacks Syrsky; EU Short Of Winter Gas. | Narrative over-coherence or source-frame smoothing. | SRC-08 | alexander-mercouris | distinct contribution |
| `pape` | unmapped | Daily source set centers on Iran With Major Strikes on Israel Coming Within 3-4 Days, Ground Invasion Coming. | Temporary daily identity requires human review. | none | moral-resistance | human review required |
| `parsi` | unmapped | Daily source set centers on The US-Saudi nuclear deal makes no sense. | Temporary daily identity requires human review. | SRC-10 | parsi | human review required |
| `ritter` | historical precedent / strategic judgment | Daily source set centers on Scott Ritter: Turn Around or Face God - Yemen Issues Chilling Warning to Saudi Ship in the Red Sea. | Historical analogy may be overextended. | SRC-09 | dialogue-works | distinct contribution |
| `weichert` | access sequence / capacity pressure | Daily source set centers on We Are Preparing for ALL OUT WAR: A Ground War Is Coming to Iran. | Interview claims about oil, submarines, proxies, and nuclear options require verification. | none | redacted-news | distinct contribution |
...
- Repeated appearances were collapsed to one voice identity but retain source multiplicity: davis, macgregor.
