...
| --- | --- | --- | --- | --- | --- | --- |
| `barnes` | legal-strategic / force feasibility | Daily source set centers on BREAKING: TRUMP CONSIDERING MASSIVE ATTACK - w/ Robert Barnes. | Compressing legal, strategic, and operational claims into one frame. | SRC-02 | mario-nawfal | distinct contribution |
| `diesen` | unmapped | Daily source set centers on Prof. Glenn Diesen: Will Putin Attack His NATO Tormentors?. | Temporary daily identity requires human review. | SRC-12 | judging-freedom | human review required |
| `henningsen` | unmapped | Daily source set centers on Patrick Henningsen: Naval Siege: Houthis Force 10+ Saudi Tankers to Turn Back After Ballistic Strikes. | Temporary daily identity requires human review. | SRC-11 | dialogue-works | human review required |
| `hoh` | unmapped | Daily source set centers on Legalized Bribery in U.S. Congress Destroying America /Matt Hoh & Lt Col Daniel Davis. | Temporary daily identity requires human review. | SRC-09 | daniel-davis | human review required |
| `johnson` | material capacity / sustainability | Daily source set centers on Larry Johnson: BREAKING: Iran Rejects U.S. Offer as Trump Weighs Massive Military Strike. | Unverified stockpile and depletion claims. | SRC-06 | dialogue-works | distinct contribution |
| `krainer` | unmapped | Daily source set centers on Alex Krainer: A Major Military Comeback Is Reshaping the Map—Right Now. | Temporary daily identity requires human review. | SRC-01 | dialogue-works | human review required |
| `krapivnik` | NATO frontier / escalation threshold | Daily source set centers on TRUMP PLANS EVEN BIGGER STRIKES ON IRAN, RUSSIA HELPING IRAN WITH THE WAR w/ STANISLAV KRAPIVNIK. | High-warning posture can outrun observed escalation. | SRC-15 | moral-resistance | distinct contribution |
| `macgregor` | unmapped | Daily source set centers on Col Douglas Macgregor: Iran May Seize Kuwait ON THE GROUND COL. Douglas Macgregor: US Abandons Its Gulf Allies. | Temporary daily identity requires human review. | SRC-03,SRC-04 | daniel-davis, judging-freedom | human review required |
...
- No material same-day convergence cluster was identified from available titles and synthesis text.

## Independence and Lineage Limits

- Repeated appearances were collapsed to one voice identity but retain source multiplicity: macgregor, marandi, wilkerson.
...
1. **P2** — diesen: voice has no canonical descriptor Action: assign or review a stable voice identity
