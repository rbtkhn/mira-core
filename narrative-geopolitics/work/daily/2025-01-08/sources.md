...
- `narrative-geopolitics/archive/sources/2025-01-08/`

## Intake Batch

This run is grounded in the `2025-01-08` day batch already landed in the central archive.

| Source File | Source Type | Intake Status | Manifest Row | Voice Route | Channel Route | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `archive/sources/2025-01-08/source-judging-freedom-sachs-does-trump-want-peace-2025-01-08.md` | transcript | `imported` | `yes` | Sachs | Judging Freedom | host-pressure test; review and narrow to owning crisis object before synthesis. |

## Run Source Set

| Source ID | Voice | Host / Channel | Modality | Archive Path | Why It Matters |
| --- | --- | --- | --- | --- | --- |
| `SRC-01` | Sachs | Judging Freedom | transcript | [2025-01-08 Sachs](../../../archive/sources/2025-01-08/source-judging-freedom-sachs-does-trump-want-peace-2025-01-08.md) | Prof. Jeffrey Sachs : Does Trump Want Peace? |
