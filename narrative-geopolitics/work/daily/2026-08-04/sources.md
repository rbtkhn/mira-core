...
This run is grounded in the `2026-08-04` day batch already landed in the central archive.
...
| --- | --- | --- |
| `SRC-01` | "Ukraine with all the struggles and a much smaller country or Russia with its massive land mass and much bigger population and army." | Ukraine/Russia asymmetry and proxy-war failure frame. |
| `SRC-02` | "He doesn't have a strategy with respect to Iran, and the claim that there are negotiations going on and so forth is frankly delusional." | Freeman critique of U.S. Iran-war strategy. |
| `SRC-03` | "When he comes out with that type of a messaging and which is the Iranians begged him not to attack, that's when you know it's the exact opposite of what happened." | Parsi reading of Trump messaging and coercive leverage. |
| `SRC-04` | "Let me let me start with what's going on between Saudi Arabia and Yemen." | Yemen/Saudi pressure as regional expansion lane. |
| `SRC-05` | "A Turkishowned cargo ship carrying fruits and vegetables to Russia was targeted by a Ukrainian drone attack near Novoros." | Maritime spillover and Odessa blockade pressure. |
| `SRC-06` | "In the past the US well threatened Oman not to make a deal with the Iranians." | Hormuz/Oman negotiation pressure and U.S. leverage attempt. |
| `SRC-07` | "Tragically, our government engages in preemptive war, otherwise known as aggression, with no complaints from the American people." | Hoh anti-war legitimacy frame for sustainment question. |
| `SRC-08` | "Far and away the most important topic is the conflict in Ukraine and where it is going." | Mercouris source lane on Ukraine battlefield direction. |
| `SRC-09` | "Yemen has attacked the Najaron airport using drones and it seems they said that they precisely hit the targets in in that airport." | Yemeni strike pressure on Saudi infrastructure. |
...
| `CLM-03` | `SRC-03` |  | Parsi via Mario Nawfal | `candidate` |
| `CLM-04` | `SRC-04` |  | Wilkerson via Nima Alkhorshid | `candidate` |
| `CLM-05` | `SRC-05` |  | Helmer via Nima Alkhorshid | `candidate` |
| `CLM-06` | `SRC-06` |  | Johnson via Glenn Diesen | `candidate` |
| `CLM-07` | `SRC-07` |  | Hoh via Judging Freedom | `candidate` |
| `CLM-08` | `SRC-08` |  | Mercouris via Alexander Mercouris | `candidate` |
| `CLM-09` | `SRC-09` |  | Marandi via Nima Alkhorshid | `candidate` |
