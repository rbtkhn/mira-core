...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `NG-20260824-F01` | By `2026-09-07`, at least one follow-on tracked source, official posture signal, or major policy discussion will frame Iran/Russia-Ukraine pressure primarily through sanctions, funding, logistics, alliance burden, domestic legitimacy, or force-stock limits rather than through a clean coercive victory narrative. | If coercion carriers are under strain, later discourse will move toward burden management and carrier protection even when public rhetoric remains escalatory. | `likely` | `2026-09-07` | Statements or tracked analyses center sanctions enforcement, budget/funding gaps, munitions or force-stock limits, alliance burden, host exposure, domestic legitimacy, or managed off-ramps. | Follow-on signals center decisive target concession, clean victory, unconstrained funding and munitions, or uncontested domestic/ally support. | `hit` if at least one qualifying follow-on signal appears by review date; `miss` if discourse remains clean-leverage/victory centered; `mixed` if both appear without one becoming dominant; `unresolvable_with_authorized_evidence` if the authorized source set is insufficient. | A target concession or visible coercive success could restore a clean leverage narrative. | `none` |
...
`SRC-11` strengthens the alliance-burden and legitimacy branches of the existing carrier-stress wager. `SRC-10` remains a held diplomacy assertion and is not a resolution source. Neither addition warrants a new hook or probability change.
