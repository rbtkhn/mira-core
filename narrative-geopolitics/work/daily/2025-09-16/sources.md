...
- `narrative-geopolitics/archive/sources/2025-09-16/`

## Intake Batch

This run is grounded in the `2025-09-16` day batch already landed in the central archive.

| Source File | Source Type | Intake Status | Manifest Row | Voice Route | Channel Route | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `archive/sources/2025-09-16/source-judging-freedom-amb-chas-freeman-how-dark-are-these-days-2025-09-16.md` | transcript | `imported` | `yes` | Freeman | Judging Freedom | host-pressure test; review and narrow to owning crisis object before synthesis. |

## Run Source Set

| Source ID | Voice | Host / Channel | Modality | Archive Path | Why It Matters |
| --- | --- | --- | --- | --- | --- |
| `SRC-01` | Freeman | Judging Freedom | transcript | [2025-09-16 Freeman](../../../archive/sources/2025-09-16/source-judging-freedom-amb-chas-freeman-how-dark-are-these-days-2025-09-16.md) | AMB. Chas Freeman : How Dark Are These Days? |
