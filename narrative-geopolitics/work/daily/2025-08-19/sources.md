...
- `narrative-geopolitics/archive/sources/2025-08-19/`

## Intake Batch

This run is grounded in the `2025-08-19` day batch already landed in the central archive.

| Source File | Source Type | Intake Status | Manifest Row | Voice Route | Channel Route | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `archive/sources/2025-08-19/source-judging-freedom-amb-chas-freeman-can-the-us-bring-peace-2025-08-19.md` | transcript | `imported` | `yes` | Freeman | Judging Freedom | host-pressure test; review and narrow to owning crisis object before synthesis. |

## Run Source Set

| Source ID | Voice | Host / Channel | Modality | Archive Path | Why It Matters |
| --- | --- | --- | --- | --- | --- |
| `SRC-01` | Freeman | Judging Freedom | transcript | [2025-08-19 Freeman](../../../archive/sources/2025-08-19/source-judging-freedom-amb-chas-freeman-can-the-us-bring-peace-2025-08-19.md) | AMB. Chas Freeman : Can the US Bring Peace? |
