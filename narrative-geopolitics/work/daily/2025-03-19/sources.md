...
- `narrative-geopolitics/archive/sources/2025-03-19/`

## Intake Batch

This run is grounded in the `2025-03-19` day batch already landed in the central archive.

| Source File | Source Type | Intake Status | Manifest Row | Voice Route | Channel Route | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `archive/sources/2025-03-19/source-judging-freedom-macgregor-will-us-attack-iran-2025-03-19.md` | transcript | `imported` | `yes` | Macgregor | Judging Freedom | cross-host pressure test; review and narrow to owning crisis object before synthesis. |

## Run Source Set

| Source ID | Voice | Host / Channel | Modality | Archive Path | Why It Matters |
| --- | --- | --- | --- | --- | --- |
| `SRC-01` | Macgregor | Judging Freedom | transcript | [2025-03-19 Macgregor](../../../archive/sources/2025-03-19/source-judging-freedom-macgregor-will-us-attack-iran-2025-03-19.md) | COL. Douglas Macgregor : Will US Attack Iran? |
...
| --- | --- | --- | --- | --- |
| `CLM-01` | `SRC-01` |  | Macgregor via Judging Freedom | `candidate` |
