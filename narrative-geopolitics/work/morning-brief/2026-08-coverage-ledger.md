...
| `2026-08-08` | no | no | `missing` | No morning-brief artifact present. |
...
- Complete receipt-paired artifacts: `5` (`2026-08-03` through `2026-08-07`).
- Markdown-only historical specimen: `1` (`2026-08-02`).
- Missing morning-brief markdown: `25` (`2026-08-01` and `2026-08-08` through `2026-08-31`).
- Dates with reconstruction caveats: `3` (`2026-08-05` through `2026-08-07`).

## Audit Notes

- August 3-7 rendered markdown does not use previous-day carry-forward language.
- August 5-7 should be treated as recovery artifacts, not full-strength
