...
ROUTING_RULES = [
    ...
    ({"composition", "lineage"}, "epistemic", "strategy-notebook", 100, "explicit Mind/Study composition lineage recall"),
    ({"tower"}, "epistemic", "strategy-notebook", 50, "notebook-first strategic inquiry continuity"),
