...
## Mind composition and Dream consumption

Steps 1–4 belong to Mind and never authorize Dream to compose or revise an
estimate. Dream consumes their existing results and applies steps 5–7 only to
its unfinished reflective bundle. Missing Mind work remains nonblocking.
...
3. For a credible Library match, use `library-reasoning geo-pilot`, read its
   ...
   operation. Preserve its gap in the Mind return point.
...
5. If Mind changed notebook context after preparation, refresh an unfinished Journal bundle with
