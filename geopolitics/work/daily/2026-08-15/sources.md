...
This run is grounded in the `2026-08-15` day batch already landed in the central archive.
...
| `archive/sources/geopolitics/sources/2026-08-15/source-iran-ceasefire-set-to-expire-on-monday-situation-static-w-elijah-magnier-2026-08-15.md` | cleaned-transcript | `imported` | `yes` | Magnier | Mario Nawfal | guest interview pressure test; review and narrow to owning crisis object before synthesis. |
...
| --- | --- | --- | --- | --- |
| `CLM-01` | `SRC-01` |  | Aguilar via Mario Nawfal | `candidate` |
