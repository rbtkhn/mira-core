...
This run is grounded in the `2026-08-06` day batch already landed in the central archive.
...
| --- | --- | --- | --- | --- |
| `CLM-20260806-01` | `SRC-01,SRC-02` | Iran policy is described as approaching a widening-war or strategic-feasibility ceiling. | Martyanov / Macgregor | `bounded-analysis` |
| `CLM-20260806-02` | `SRC-04,SRC-06,SRC-07` | Ukraine/Russia demonstrates limits in drones, air defense, industrial depth, and rearmament. | Mearsheimer / Mercouris | `bounded-analysis` |
| `CLM-20260806-03` | `SRC-05` | War-origin narratives remain part of the settlement terrain. | Marandi | `bounded-analysis` |
| `CLM-20260806-04` | `SRC-03` | Press-freedom and anti-war narrative pressure may become part of domestic war management. | Blumenthal | `source_assertion` |
