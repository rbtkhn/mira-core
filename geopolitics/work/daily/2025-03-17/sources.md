...
- `narrative-geopolitics/archive/sources/2025-03-17/`

## Intake Batch

This run is grounded in the `2025-03-17` day batch already landed in the central archive.

| Source File | Source Type | Intake Status | Manifest Row | Voice Route | Channel Route | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `archive/sources/2025-03-17/source-diesen-sachs-peace-negotiations-and-the-end-of-nato-2025-03-17.md` | transcript | `imported` | `yes` | Sachs | Glenn Diesen | host-pressure test; review and narrow to owning crisis object before synthesis. |

## Run Source Set

| Source ID | Voice | Host / Channel | Modality | Archive Path | Why It Matters |
| --- | --- | --- | --- | --- | --- |
| `SRC-01` | Sachs | Glenn Diesen | transcript | [2025-03-17 Sachs](../../../archive/sources/2025-03-17/source-diesen-sachs-peace-negotiations-and-the-end-of-nato-2025-03-17.md) | Jeffrey Sachs: Peace Negotiations & the End of NATO |
...
| --- | --- | --- | --- | --- |
| `CLM-01` | `SRC-01` |  | Sachs via Glenn Diesen | `candidate` |
