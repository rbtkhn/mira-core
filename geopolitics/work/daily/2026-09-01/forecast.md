...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `none` | No new accountable forecast hook is issued in this issue-generation pass. | Crisis-object deepening came first; forecast sharpening remains a separate governed phase. | `none` | `none` | `none` | `none` | `none` | `none` | `none` |
