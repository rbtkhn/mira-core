...
- `narrative-geopolitics/archive/sources/2026-02-01/`

## Intake Batch

This run is grounded in the `2026-02-01` day batch already landed in the central archive.

| Source File | Source Type | Intake Status | Manifest Row | Voice Route | Channel Route | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `archive/sources/2026-02-01/source-alexander-mercouris-iran-readies-for-big-war-zelensky-dithers-postpones-talks-predicts-failu-2026-02-01.md` | transcript | `imported` | `yes` | Mercouris | Alexander Mercouris | stream-sequence spine; review and narrow to owning crisis object before synthesis. |

## Run Source Set

| Source ID | Voice | Host / Channel | Modality | Archive Path | Why It Matters |
| --- | --- | --- | --- | --- | --- |
| `SRC-01` | Mercouris | Alexander Mercouris | transcript | [2026-02-01 Mercouris](../../../archive/sources/2026-02-01/source-alexander-mercouris-iran-readies-for-big-war-zelensky-dithers-postpones-talks-predicts-failu-2026-02-01.md) | Iran Readies For Big War; Zelensky Dithers Postpones Talks Predicts Failure; Russia Restarts Strikes |
