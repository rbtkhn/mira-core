...
- `narrative-geopolitics/archive/sources/2025-06-13/`

## Intake Batch

This run is grounded in the `2025-06-13` day batch already landed in the central archive.

| Source File | Source Type | Intake Status | Manifest Row | Voice Route | Channel Route | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `archive/sources/2025-06-13/source-judging-freedom-wilkerson-foreign-policy-in-chaos-2025-06-13.md` | transcript | `imported` | `yes` | Wilkerson | Judging Freedom | host-pressure test; review and narrow to owning crisis object before synthesis. |

## Run Source Set

| Source ID | Voice | Host / Channel | Modality | Archive Path | Why It Matters |
| --- | --- | --- | --- | --- | --- |
| `SRC-01` | Wilkerson | Judging Freedom | transcript | [2025-06-13 Wilkerson](../../../archive/sources/2025-06-13/source-judging-freedom-wilkerson-foreign-policy-in-chaos-2025-06-13.md) | COL. Lawrence Wilkerson : Foreign Policy in Chaos. |
