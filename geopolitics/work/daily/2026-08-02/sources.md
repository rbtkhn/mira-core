...
This run is grounded in the `2026-08-02` day batch already landed in the central archive.
...
| --- | --- | --- |
| `SRC-01` | "Donald Trump finally said he cancelled the attack on Iran which was supposed to attack all those civilian infrastructure, the power grids, everything there." | Cancelled-strike and infrastructure-target sequence. |
| `SRC-02` | "And I want to get your first thoughts on this Iran war as we are looking at Sunday, August 2nd." | Iran-war danger framing for Ritter source lane. |
| `SRC-03` | "Donald Trump finally has decided to cancel the attack which would could have been devastating for the whole region for the west Asia." | McGovern shockwave frame after canceled attack. |
| `SRC-04` | "I guess I shouldn't have not changed my mind, but I shouldn't have started questioning my thesis that the war is over." | Weichert deal/war-status uncertainty frame. |
| `SRC-05` | "After much fanfare in the days leading up to today on Sunday, President Trump has again done the infamous taco and has backed down from attacking Iran." | Davis cancelled-attack narrative and credibility pressure. |
| `SRC-06` | "There was an attack on the bridge using FAB bombs, but from what I can work out, these were launched at the furthest extent of their range." | Ukraine/Odessa secondary logistics and strike-capability lane. |
| `SRC-07` | "We can't do our job. If we can't defend Europe, we can't provide to Ukraine." | Adds the munitions-stock and global-force-posture constraint to the escalation analysis. |
...
| `CLM-02` | `SRC-02` |  | Ritter via Cyrus Janssen | `candidate` |
| `CLM-03` | `SRC-03` |  | McGovern via Dialogue Works | `candidate` |
| `CLM-04` | `SRC-04` |  | Weichert via Mario Nawfal | `candidate` |
| `CLM-05` | `SRC-05` |  | Davis via Daniel Davis | `candidate` |
| `CLM-06` | `SRC-06` |  | Mercouris via Alexander Mercouris | `candidate` |
| `CLM-07` | `SRC-07` |  | Aguilar via Mario Nawfal | `candidate` |
