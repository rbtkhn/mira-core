...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `NG-20260801-F01` | If infrastructure strikes occur, regional basing and energy exposure will become the primary constraint on coalition freedom of action. | Retaliation against exposed systems raises the cost of sustaining operations faster than limited strikes restore leverage. | `plausible` | 2026-08-08 | Strikes remain limited or deferred. | Independent AIS/traffic, insurer, or energy-flow evidence shows whether the constraint persists. | Commercial passage or regional basing remains measurably constrained or normalizes by review date. | Commentary convergence overstates the operational constraint. | `none` |
