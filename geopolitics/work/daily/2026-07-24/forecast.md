...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `NG-20260724-F01` | Within 30 days, another regional chokepoint or Gulf export route becomes an explicit bargaining object | coercion shifts toward control of passage and energy access | plausible | 2026-08-24 |  |  | reciprocal transit terms are announced and implemented | a negotiated pause separates the theaters | `none` |
