...
- `narrative-geopolitics/archive/sources/2025-08-13/`

## Intake Batch

This run is grounded in the `2025-08-13` day batch already landed in the central archive.

| Source File | Source Type | Intake Status | Manifest Row | Voice Route | Channel Route | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `archive/sources/2025-08-13/source-the-third-coming-2025-08-13.md` | substack-post | `imported` | `yes` | Jiang | Predictive History | guest interview pressure test; review and narrow to owning crisis object before synthesis. |

## Run Source Set

| Source ID | Voice | Host / Channel | Modality | Archive Path | Why It Matters |
| --- | --- | --- | --- | --- | --- |
| `SRC-01` | Jiang | Predictive History | substack-post | [2025-08-13 Jiang](../../../archive/sources/2025-08-13/source-the-third-coming-2025-08-13.md) | The Third Coming |
...
| --- | --- | --- | --- | --- |
| `CLM-01` | `SRC-01` |  | Jiang via Predictive History | `candidate` |
