...
def test_manifest_count_mismatch_is_detected(monkeypatch, tmp_path: Path) -> None:
    ...
    manifest = {
        ...
        "sources": [
            {
                "date": "2026-07-09",
                "local_path": "archive/sources/geopolitics/sources/2026-07-09/source-a.md",
            }
        ],
    }
...
def test_archive_manifest_rejects_partial_hydration(monkeypatch, tmp_path: Path) -> None:
    ...
    assert integrity.archive_manifest_failures() == [
        "manifest path missing file: archive/sources/geopolitics/sources/2026-07-09/source-a.md"
    ]
...
def test_markdown_archive_links_use_manifest_when_hydration_is_absent(
    ...
    monkeypatch.setattr(
        integrity,
        "ARCHIVE_SOURCES",
        tmp_path / "archive" / "sources" / "geopolitics" / "sources",
    )
    ...
    assert integrity.markdown_link_failures() == [
        "broken Markdown link: docs/note.md -> ../archive/sources/geopolitics/sources/missing.md"
    ]
