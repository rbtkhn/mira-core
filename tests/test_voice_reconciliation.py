...
def manifest_row(path: str, slug: str, *, host: str = "dialogue-works", title: str = "Source") -> dict:
    return {
        ...
        "title": title,
        "local_path": path,
        "voice_index_path": "../../../archive/sources/geopolitics/sources/2026-07-10/source.md",
...
def test_metadata_accepts_absent_ignored_hydration(tmp_path: Path) -> None:
    rel = "archive/sources/geopolitics/sources/2026-07-10/source.md"
...
def test_metadata_rejects_missing_file_in_partial_hydration(tmp_path: Path) -> None:
    rel = "archive/sources/geopolitics/sources/2026-07-10/source.md"
    (tmp_path / "archive" / "sources" / "geopolitics" / "sources").mkdir(parents=True)
    manifest = {"sources": [manifest_row(rel, "johnson")]}
...
def test_standard_shelf_sync_is_idempotent_and_preserves_role(monkeypatch, tmp_path: Path) -> None:
    ...
    first_rel = "archive/sources/geopolitics/sources/2026-07-09/a.md"
    second_rel = "archive/sources/geopolitics/sources/2026-07-10/b.md"
    existing = "| `2026-07-09` | A | `guest interview pressure test` | `dialogue-works` | [source](../../../archive/sources/geopolitics/sources/2026-07-09/a.md) |\n"
...
def test_shelf_less_voice_is_reported_not_failed(monkeypatch, tmp_path: Path) -> None:
    ...
    rel = "archive/sources/geopolitics/sources/2026-07-10/x.md"
    target = tmp_path / rel
    target.parent.mkdir(parents=True)
    target.write_text("source\n")
...
def test_role_override_registry_rejects_orphan_path() -> None:
    ...
    failures = voice_indexes.role_override_failures(
        manifest,
        {("johnson", "archive/sources/geopolitics/sources/missing.md"): "curated"},
    )
    assert failures == [
        "voice-role override path absent from manifest: "
        "archive/sources/geopolitics/sources/missing.md"
    ]
